...
const QuestionPage = ({ language }) => {
  ...
  const backButton =
    ...
    const onClick1 = () => {
      router.push(paths.question21);
    }
    const onClick2 = () => {
      router.push(paths.question22);
    }
  return (
    <Templates>
      ...
      <YellowButtonWrapper>
        <Button children="選択肢1" variant="yellow" onClick={onClick1}/>
        <Button children="選択肢2" variant="yellow" onClick={onClick2}/>
      </YellowButtonWrapper>
      <ButtonWrapper>
